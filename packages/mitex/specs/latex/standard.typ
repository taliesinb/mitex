...
#let (
  ...
  approx: define-sym("mitexapprox", sym: math.scripts(std.sym.approx)),
  ...
  sim: define-sym("mitexsim", sym: math.scripts(std.sym.tilde.op)),
  simeq: define-sym("mitexsimeq", sym: math.scripts(std.sym.tilde.eq)),
  backsimeq: define-sym("mitexbacksimeq", sym: math.scripts(std.sym.tilde.eq.rev)),
  cong: define-sym("mitexcong", sym: math.scripts(std.sym.tilde.equiv)),
  ...
  equiv: define-sym("mitexequiv", sym: math.scripts(std.sym.equiv)),
  ...
  dashleftarrow: define-sym("arrow.l.dashed"),
  dashrightarrow: define-sym("arrow.dashed"),
  dbcolon: define-sym("::"),
